...
const WhatsAppFloat = () => {
  ...
  const handleWhatsAppClick = () => {
    window.open('https://wa.me/21651519222', '_blank');
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        {/* Tooltip */}
        {showTooltip && (
          <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-navy text-ivory text-sm rounded-lg whitespace-nowrap shadow-lg transform transition-all duration-200 opacity-100">
